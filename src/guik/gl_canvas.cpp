...
namespace guik
{
   ...
   * @param size
   */
  GLCanvas::GLCanvas(const std::string &data_directory, const Eigen::Vector2i &size) : size(size), point_size(0.0f), keyframe_scale(1.0f), min_z(-3.0f), max_z(10.0f), z_clipping(true)
  {
